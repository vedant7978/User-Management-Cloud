...
function App() {
  ...
  const createUser = async () => {
    ...
    const response = await fetch(
      "https://crvno4jsng.execute-api.us-east-1.amazonaws.com/Prod/createUser",
      {
        method: "POST",
  ...
  const updateUser = async (userId) => {
    const response = await fetch(
      "https://crvno4jsng.execute-api.us-east-1.amazonaws.com/Prod/updateUser",
      {
        method: "PUT",
  ...
  const deleteUser = async (userId) => {
    ...
    const response = await fetch(
      "https://crvno4jsng.execute-api.us-east-1.amazonaws.com/Prod/deleteUser",
      {
        method: "DELETE",
  ...
  const fetchAllUsers = async () => {
    const response = await fetch(
      "https://crvno4jsng.execute-api.us-east-1.amazonaws.com/Prod/getUser"
    );
    const data = await response.json();
